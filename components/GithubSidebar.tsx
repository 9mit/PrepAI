                ...
                <div className="space-y-1 max-h-60 overflow-y-auto pr-2 custom-scrollbar">
                    {loading ? (
                        ...
                        repos.map(repo => (
                            ...
                            >
                                <i className="fa-regular fa-folder text-[var(--neon-cyan)]"></i>
                                {repo.name}
                            </button>
                        ))
                    )}
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(5,10,20,0.8)] backdrop-blur-sm p-8 animate-fadeIn">
                    <div className="w-full max-w-5xl h-[85vh] flex flex-col glass-card overflow-hidden">
                        ...
                        <div className="flex items-center justify-between p-4 border-b border-[rgba(255,255,255,0.05)] bg-[rgba(10,22,40,0.5)]">
                            ...
                            <a href={selectedRepo.html_url} target="_blank" rel="noopener noreferrer" className="px-4 py-2 rounded-lg bg-[var(--neon-cyan)]/10 text-[var(--neon-cyan)] text-xs font-bold uppercase tracking-wider hover:bg-[var(--neon-cyan)]/20 transition-colors">
                                ...
                                <div className="flex-1 overflow-y-auto p-2 space-y-1">
                                    {files
                                        ...
                                        .map(file => (
                                            ...
                                            >
                                                <i className={`fa-${file.type === 'dir' ? 'regular fa-folder' : 'solid fa-file-code'} ${file.type === 'dir' ? 'text-[var(--neon-cyan)]' : 'text-[var(--slate-500)]'}`}></i>
                                                {file.name}
                                            </button>
                                        ))}
                                </div>
