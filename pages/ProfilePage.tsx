...
const ProfilePage: React.FC<ProfilePageProps> = ({ user, onUpdateUser }) => {
    ...
    return (
        ...
        >
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                ...
                {!isEditing && (
                    <button
                        ...
                        className="px-6 py-3 rounded-xl bg-[var(--neon-emerald)]/10 border border-[var(--neon-emerald)]/30 text-[var(--neon-emerald)] font-bold uppercase tracking-widest hover:bg-[var(--neon-emerald)]/20 transition-all"
                    >
            ...
            {completion < 100 && (
                <motion.div variants={itemVariants} className="p-6 rounded-3xl bg-gradient-to-r from-[var(--bg-surface)] to-[var(--bg-accent)] border border-[var(--neon-emerald)]/40 relative overflow-hidden group">
                    <div className="absolute top-0 right-0 w-64 h-64 bg-[radial-gradient(circle,rgba(16,185,129,0.15)_0%,transparent_70%)] blur-3xl group-hover:opacity-75 transition-opacity"></div>
                    <div className="relative z-10 flex items-center justify-between">
                        <div className="flex items-center gap-6">
                            <div className="relative w-16 h-16">
                                <svg className="w-full h-full -rotate-90" viewBox="0 0 36 36">
                                    ...
                                    <path className="text-[var(--neon-emerald)] transition-all duration-1000 ease-out" strokeDasharray={`${completion}, 100`} d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" strokeWidth="3" />
                                </svg>
                        ...
                        {!isEditing && (
                            <button onClick={() => setIsEditing(true)} className="text-sm font-bold text-[var(--neon-emerald)] hover:underline">Complete Now</button>
                        )}
                    </div>
                </motion.div>
            )}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <motion.div variants={itemVariants} className="lg:col-span-1 space-y-6">
                    <div className="p-8 rounded-[2.5rem] glass-card text-center relative overflow-hidden">
                        <div className="w-32 h-32 rounded-full mx-auto mb-6 bg-gradient-to-br from-[var(--neon-emerald)] to-[var(--neon-cyan)] p-1 shadow-2xl">
                            <div className="w-full h-full rounded-full bg-[var(--bg-accent)] flex items-center justify-center text-4xl font-bold font-display text-white">
                                {user.name.slice(0, 2).toUpperCase()}
                            </div>
                        </div>
                        <h2 className="text-xl font-bold text-white mb-1">{user.name}</h2>
                        <p className="text-xs font-bold uppercase tracking-widest text-[var(--neon-emerald)] mb-6">{user.email}</p>
                        ...
                        <div className="space-y-4 text-left">
                            <div>
                                ...
                                {isEditing ? (
                                    <textarea
                                        className="w-full bg-[var(--bg-accent)] border border-[rgba(255,255,255,0.1)] rounded-xl p-3 text-sm text-white focus:border-[var(--neon-emerald)] outline-none min-h-[100px] resize-none"
                                        value={formData.bio || ''}
                            ...
                            <div>
                                ...
                                {isEditing ? (
                                    <input
                                        type="number"
                                        className="w-full bg-[var(--bg-accent)] border border-[rgba(255,255,255,0.1)] rounded-xl p-3 text-sm text-white focus:border-[var(--neon-emerald)] outline-none"
                                        value={formData.age || ''}
                ...
                <div className="lg:col-span-2 space-y-6">
                    <motion.div variants={itemVariants} className="p-8 rounded-[2.5rem] glass-card space-y-8">
                        <div className="flex items-center gap-4 border-b border-[rgba(255,255,255,0.05)] pb-4 mb-4">
                            <div className="w-10 h-10 rounded-xl bg-[var(--neon-emerald)]/10 flex items-center justify-center text-[var(--neon-emerald)]">
                            ...
                            <div>
                                ...
                                {isEditing ? (
                                    ...
                                    <a
                                        ...
                                        className="text-sm text-[var(--neon-emerald)] hover:underline flex items-center gap-2"
                                    >
                ...
                <div className="fixed bottom-4 right-4 sm:bottom-8 sm:right-8 z-40 animate-slideUp">
                    <div className="glass-panel p-2 rounded-2xl flex gap-3 shadow-2xl">
                        ...
                        <button
                            type="button"
                            onClick={handleSave}
                            className="btn-primary px-8 py-3 rounded-xl font-bold shadow-lg transform hover:-translate-y-1 transition-all"
